          ...
          <div className="arrow-x bg-un-red row px-5 py-3 custom-banner" style={{ minHeight: '300px' }}>
            <div className="content-wrapper">
              <div className="col-12 col-xl-2 g-0 ps- logo-container">
                <img src="/sites/default/files/2025-09/unctad-16-logo-white.png" data-entity-uuid="18237496-2ea6-4c78-abca-3ac10e353be3" data-entity-type="file" alt="16th UN Conference on Trade and Development logo" />
              </div>
              <div
